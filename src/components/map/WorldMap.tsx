...
export function WorldMap({ cities, baseCity, baseTime, use12h, isDark, useAnalog, themeMode, onCityClick, onSetFormat, onSetAnalog, onSetTheme, onTimeChange }: WorldMapProps) {
  ...
  return (
    ...
    >
      ...
      {/* Top bar: single flex row to prevent left/right overlap on zoom */}
      <div className="absolute top-4 left-5 right-5 z-20 flex items-center justify-between gap-2 pointer-events-none [&>*]:pointer-events-auto">

        {/* Right group: GitHub + About */}
        ...
        {/* Left group: brand + 12/24h toggle + theme toggle */}
